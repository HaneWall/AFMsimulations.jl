module AFMsimulations
    ...
    export f_LJ!, f_vLJ!, f_vLJ, f_DMT!, f_DMT, f_DMT_auto!, f_eDMT!, f_vDMT!

    include("utilities.jl")
    export eff_young_module, force_distance, Φ_poincare, savitzky_golay_filter, lsq_regression, sinusoidal_bases, sinusoidal_bases_1d
